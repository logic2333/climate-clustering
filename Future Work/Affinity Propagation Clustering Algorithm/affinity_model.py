...
from ML_Project.Map_Plot import plot_map
alpha = 2.29
np.random.seed(1)
...
models =[]
models.append(AffinityPropagation(damping=0.9,random_state=1))
models.append(AffinityPropagation(damping=0.8,random_state=1))
