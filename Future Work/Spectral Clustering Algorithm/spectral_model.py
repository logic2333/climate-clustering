...
models =[]
models.append(('SpectralClustering18', SpectralClustering(n_components=18, random_state=1),18))
models.append(('SpectralClustering20', SpectralClustering(n_components=20, random_state=1),20))
models.append(('SpectralClustering22', SpectralClustering(n_components=22, random_state=1),22))
models.append(('SpectralClustering24', SpectralClustering(n_components=24, random_state=1),24))
models.append(('SpectralClustering26', SpectralClustering(n_components=26, random_state=1),26))
models.append(('SpectralClustering29', SpectralClustering(n_components=29, random_state=1),29))
models.append(('SpectralClustering30', SpectralClustering(n_components=30, random_state=1),30))
...
for name, model,k in models:
    ...
    df = principalDf.copy()
    plot_map('SpectralClustering',k,df,lonSeries,latSeries)

    if k ==29:
        plot_maps('SpectralClustering', k, df, lonSeries, latSeries)
