...
cats = ["", "Subarctic Oceanic/Oceanic Tundra", "Subarctic", "Cold Temperate", ...
    "Arctic Tundra(Continental)", "Arctic Icecap(Oceanic)", "Arctic Icecap(Continental)", ...
    "Subarctic Monsoonal", "Cool Temperate Oceanic", "Cool Temperate", ...
    "Cool and Wet Mediterranean/Cool Temperate Dry-summer", ...
    "Cool Temperate Suboceanic/Cool-warm Temperate Transitional(Oceanic)", ...
    "Cool Temperate Steppe", "Cool Temperate Steppe(Mediterranean/Wet-winter)", ...
    "Classical Mediterranean/Subtropical Dry-summer", "Cold Desert/Cool Temperate Arid(Summer-rain)", ...
    "Warm Temperate Oceanic", "Warm Temperate", "Warm Temperate Monsoonal", "Subtropical Monsoonal(Humid)", ...
    "Tropical Rainforest", "Subtropical Savanna/Subtropical Dry-wet Season", "Tropical Monsoonal(Humid)", ...
    "Tropical Savanna/Tropical Dry-wet Season", "Mild Hot Desert/Oasis/Subtropical Arid", ...
    "Tropical Steppe/Tropical Semi-arid", "Hot Desert/Tropical Desert"];
