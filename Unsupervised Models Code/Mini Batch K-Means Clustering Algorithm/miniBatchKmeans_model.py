...
climate_dataset = pd.read_csv('/Users/bilalhussain/Downloads/data_mat.csv')
mapped_dataset = pd.read_csv('/Users/bilalhussain/Downloads/mapped_data.csv')
koppen_dataset = pd.read_csv('/Users/bilalhussain/Downloads/koppen_data.csv')
